...
QuantumAI 是**本地优先的数字员工工作台**：不是单一聊天工具，而是把「对话 / 项目编排 / Skills / 知识库 / 自动化 / 资产」组织在**数字员工**职责之下，并通过**本地通道网关**让外部 IM（Telegram/飞书）与**远程中继终端**也能调度同一套能力。
...
│                                       ▼                                   │
│  ┌────────────────────────────────────────────────────────────┐           │
│  │ apps/api（Fastify，端口 4428，localhost）                     │           │
