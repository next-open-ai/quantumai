...
`feat: migrate QuantumAI toward dual publishable desktop + npm web runtime`
...
本 PR 的目标，是让 QuantumAI 从单一 Electron 桌面形态，升级为同时支持：
