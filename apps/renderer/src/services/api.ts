...
export async function getHealth(): Promise<HealthStatus> {
  const apiBase = window.location.protocol === 'file:' ? 'http://127.0.0.1:4428' : '';
...
function knowledgeApiBase() {
  return window.location.protocol === 'file:' ? 'http://127.0.0.1:4428' : '';
}
...
function dataApiBase() { return window.location.protocol === 'file:' ? 'http://127.0.0.1:4428' : ''; }
