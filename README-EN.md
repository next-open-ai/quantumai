...
**QuantumAI - a cross-platform, local-first AI workspace for digital employees.**
...
Default local API port: `4428`.  
Default data directory: `~/.workmate`.

## Runtime shapes

QuantumAI currently supports four practical runtime shapes:
